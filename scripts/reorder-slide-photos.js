...
async function reorderSlidePhotos() {
  try {
    console.log('🔄 Переупорядочиваем фотографии секции "Сдвигайте"...');
    ...
    // Новый порядок: убираем IMG_8885 из второй позиции
    // Вариант 1: IMG_8886, IMG_5642, IMG_8885, IMG_5643
    console.log('\n🔄 Устанавливаем новый порядок:');
    console.log('   1. IMG_8886 (первая пара - слева)');
    console.log('   2. IMG_5642 (первая пара - справа)');
    console.log('   3. IMG_8885 (вторая пара - слева)');
    ...
    console.log('\n✅ Порядок обновлен!');
    console.log('📷 Новый порядок секции "Сдвигайте":');
    console.log('   1. IMG_8886 (первая пара)');
    console.log('   2. IMG_5642 (первая пара)');
    console.log('   3. IMG_8885 (вторая пара)');
    console.log('   4. IMG_5643 (вторая пара)');
