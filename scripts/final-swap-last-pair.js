...
async function finalSwapLastPair() {
  try {
    console.log('🔄 ФИНАЛЬНО меняем местами IMG_8871 и IMG_8872...');
    ...
    console.log(`   IMG_8872: ${photo8872.order} (сейчас "до")`);
    console.log(`   IMG_8871: ${photo8871.order} (сейчас "после")`);
    
    // Меняем местами: IMG_8871 должно быть "до" (слева), IMG_8872 "после" (справа)
    console.log('\n🔄 ФИНАЛЬНО меняем местами:');
    console.log('   5. IMG_8871 (третья пара - "до", слева)');
    console.log('   6. IMG_8872 (третья пара - "после", справа)');
    ...
    console.log('\n✅ ФИНАЛЬНЫЙ порядок установлен!');
    console.log('📷 Правильная последняя пара:');
    console.log('   IMG_8871 → IMG_8872 (до → после)');
    ...
    console.error('❌ Ошибка при финальном изменении порядка:', error);
  }
}
