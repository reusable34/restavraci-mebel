        ...
        <div className="flex h-16 md:h-20 lg:h-24 items-center justify-between gap-4">
          <div className="flex items-center gap-3 md:gap-4 min-w-0">
            ...
            <button
              ...
              className="text-sm md:text-base lg:text-lg hover:text-[var(--accent)] transition-colors cursor-pointer whitespace-nowrap hidden sm:block"
          ...
          <nav className="flex items-center gap-3 md:gap-4 lg:gap-6 text-sm md:text-base lg:text-lg text-[var(--text)] flex-shrink-0">
            <Link href="/services" className="hover:text-[var(--accent)] whitespace-nowrap">Услуги</Link>
            <Link href="/portfolio" className="hover:text-[var(--accent)] whitespace-nowrap">Портфолио</Link>
            <Link href="/contacts" className="hover:text-[var(--accent)] whitespace-nowrap">Контакты</Link>
            <div className="flex items-center gap-2 md:gap-3 ml-1 md:ml-2">
              <a 
                href="https://wa.me/79525564020" 
                target="_blank" 
                rel="noopener noreferrer"
                className="hover:scale-110 transition-transform p-1 flex items-center justify-center"
