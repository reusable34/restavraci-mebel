        ...
        <div className="flex h-16 md:h-20 lg:h-24 items-center justify-between gap-4">
          ...
          <nav className="flex items-center gap-4 md:gap-6 lg:gap-8 text-sm md:text-base lg:text-lg text-[var(--text)]">
            ...
            <div className="flex items-center gap-3 ml-2">
              ...
              >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.562 8.193l-1.87 8.788c-.14.625-.5.777-1.015.48l-2.8-2.063-1.35 1.297c-.15.15-.275.275-.565.275l.2-2.82 5.183-4.68c.225-.2-.05-.31-.348-.11l-6.403 4.03-2.76-.86c-.6-.188-.615-.6.125-.895l10.78-4.155c.5-.19.937.112.775.865z" fill="currentColor"/>
                </svg>
              </a>
            </div>
          </nav>
